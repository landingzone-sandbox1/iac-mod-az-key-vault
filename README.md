...
| [azurerm_role_assignment.this](https://registry.terraform.io/providers/hashicorp/azurerm/4.28.0/docs/resources/role_assignment) | resource |
...
| <a name="input_naming"></a> [naming](#input\_naming) | Naming convention object for resource naming. | <pre>object({<br/>    application_code = string<br/>    region_code      = string<br/>    environment      = string<br/>    correlative      = string<br/>    objective_code   = string<br/>  })</pre> | `null` | no |
...
| <a name="input_network_settings"></a> [network\_settings](#input\_network\_settings) | Network configuration for the Key Vault. | <pre>object({<br/>    firewall_ips    = optional(list(string), [])<br/>    vnet_subnet_ids = optional(list(string), [])<br/>  })</pre> | <pre>{<br/>  "firewall_ips": [],<br/>  "vnet_subnet_ids": []<br/>}</pre> | no |
